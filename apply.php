...
if (isset($_GET)) {
	...
	if ($total >= $eligibility) {
		if ($course1 == $course2) {
			...
			$sql1 = "SELECT * FROM apply_job_post WHERE username='$_SESSION[username]' AND id_jobpost='$_GET[id]'";
			...
			if ($result1->num_rows == 0) {
				...
				$sql = "INSERT INTO apply_job_post(id_jobpost, id_company, username) VALUES ('$_GET[id]', '$_SESSION[id_company]', '$_SESSION[username]')";
