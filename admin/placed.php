                            ...
                            <div class="box-body table-responsive no-padding">
                                <table id="example2" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "select * from users inner join apply_job_post INNER JOIN job_post where users.username = apply_job_post.username AND apply_job_post.id_jobpost = job_post.id_jobpost;;";
                                        $_SESSION['QUERY'] = $sql;
