                        ...
                        ?>
                            <tr>
                              ...
                              <td>
                                ...
                                ?>
                                  <a href="reject-student.php?id=<?php echo $row['firstname']; ?>">Reject</a> <a href="approve-student.php?id=<?php echo $row['firstname']; ?>">Approve</a>
                                <?php
                                } else if ($row['active'] == '3') {
                                ?>
                                  <a href="approve-student.php?id=<?php echo $row['firstname']; ?>">Reactivate</a>
                                <?php
                              ...
                              <td><a href="delete-student.php?id=<?php echo $row['firstname']; ?>">Delete</a></td>
                            </tr>
