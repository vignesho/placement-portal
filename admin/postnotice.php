...
if (isset($_POST['submit'])) {
    ...
    //     move_uploaded_file(
    //         $_FILES["resume"]["tmp_name"],$filename);
    // }
            ...
            <section>
                ...
                <form class="centre " action="" method="POST">
                    ...
                    <div id="file" class="form-group">
                        ...
                        <input type="url" name="url" id='url' class="btn btn-flat btn-primary" placeholder="enter url">
                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <!-- <?php if ($row['resume'] != '') { ?>
                                        <td><a href="$row['resume'] >"download="<?php echo 'Notice'; ?>"><i class="fa fa-file"></i></a></td>
                                    <?php } else { ?>
