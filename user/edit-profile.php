  ...
  <div class="wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              <form action="update-profile.php" method="post" enctype="multipart/form-data">
                ...
                $sql = "SELECT * FROM users WHERE firstname='$_SESSION[name]'";
                    ...
                    <div class="row">
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="Marks" name="hsc" placeholder="Percentage/CGPA" value="<?php echo $row['tenth']; ?>">
                        </div>
                        <div class="form-group">
                          <label for="Marks">12th Marks</label>
                          <input type="text" class="form-control input-lg" id="Marks" name="ssc" placeholder="Percentage/CGPA" value="<?php echo $row['twelfth']; ?>">
                        </div>
                      ...
                      <div class="col-md-6 latest-job ">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control input-lg" id="Marks" name="ug" placeholder="Percentage/CGPA" value="<?php echo $row['cgpa']; ?>">
                        </div>
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="learningfromscratch.online">Placement Portal. Created by STRAW HAT PIRATES.</a>.</strong> All rights
        reserved.
      </div>
    </footer>
