 ...
 <img src="assets/img/saecicon.png"  style="height:70px;position:fixed;top:3px " />
     <div class="container-fluid d-flex align-items-center justify-content-between">
             ...
             <ul>
                 ...
                 <li class="dropdown"><a href="login.php"><span>Register</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                     <ul>
                         ...
                         <li><a href="reg.php">Students</a></li>
         ...
         <!-- <a class="btn-get-started scrollto" href="faq.php">PDRIVE</a> -->
         <a class="button" href="#">
    <span></span>
    <span></span>
    <span></span>
