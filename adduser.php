...
if (isset($_POST)) {
	...
	// $ono = mysqli_real_escape_string($conn, $_POST['ono']);
	...
	$hoa = mysqli_real_escape_string($conn, $_POST['hoa']);
	...
	if ($result->num_rows == 0) {
		...
		$sql = "INSERT INTO users(password, firstname, lastname, email, contactno, dob, aadhar, pan, stream, passingyear, section , gender , address , city , state , pin, skills , ssc , hsc , ug , hoa , ca , study, hs, resume) VALUES ('$password','$firstname', '$lastname', '$email','$contactno' , '$dob' , '$aadhar', '$pan',  '$dept' , '$year', '$section', '$gender' , '$address', '$city' , '$state' , '$pin' , '$skills', '$tenth', '$twelfth' , '$cgpa' , '$hoa' , '$ca', '$study', '$hs', '$file')";
